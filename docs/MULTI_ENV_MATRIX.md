# SM-Data-Exchange 多环境配置矩阵（MULTI-ENV MATRIX）
...
| 数据库名 | sm_data_exchange_dev | sm_data_exchange_staging | sm_data_exchange |
| 域名 | sm-data-exchange.dev.sm.example.com | sm-data-exchange.staging.sm.example.com | sm-data-exchange.sm.example.com |
